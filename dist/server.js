...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };\n\nvar _models = __webpack_require__(/*! ../models */ \"./src/models/index.js\");\n\nexports.default = {\n    cubstart: function cubstart(req, res, next) {\n        _models.User.findOne({\n            where: { id: req.user.id },\n            include: [{ model: _models.Application }, { model: _models.CubStart }, { model: _models.Team, include: [_models.User] }]\n        }).then(function (user) {\n            res.render('cubstart', { user: user.toJSON() });\n        });\n    },\n\n    submitApp: function submitApp(req, res, next) {\n        var data = req.body;\n        _models.User.findOne({\n            where: { id: req.user.id },\n            include: { model: _models.CubStart }\n        }).then(function (user) {\n            if (data['toggle-cubstart'] == 'no') {\n                // If there's a CubStart app associated with this\n                // user, delete it\n                user.setCubStart(null).then(function () {\n                    res.redirect('/dashboard');\n                });\n            } else if (user.CubStart === null) {\n                _models.CubStart.create(_extends({}, data, {\n                    UserId: req.user.id\n                })).then(function (newApp) {\n                    // App has been created.\n                    res.redirect('/dashboard');\n                });\n            } else {\n                user.CubStart.updateAttributes(data).then(function (newApp) {\n                    // App has been saved.\n                    res.redirect('/dashboard');\n                });\n            }\n        });\n    }\n};\n\n//# sourceURL=webpack:///./src/controllers/cubstart.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nexports.default = function (sequelize, DataTypes) {\n    var CubStart = sequelize.define('CubStart', {\n        cubstart1: {\n            type: DataTypes.TEXT,\n            validate: {\n                notEmpty: true\n            }\n        },\n        cubstart2: {\n            type: DataTypes.TEXT,\n            validate: {\n                notEmpty: true\n            }\n        },\n        cubstart3: {\n            type: DataTypes.TEXT,\n            validate: {\n                notEmpty: true\n            }\n        },\n        cubstart4: {\n            type: DataTypes.TEXT,\n            validate: {\n                notEmpty: true\n            }\n        }\n    }, {});\n\n    CubStart.associate = function (models) {\n        models.CubStart.belongsTo(models.User);\n    };\n    return CubStart;\n};\n\n//# sourceURL=webpack:///./src/models/cubstart.js?");
