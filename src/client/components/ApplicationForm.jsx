...
export default class extends React.Component {
    verifyResume(evt) {
        alert(document.getElementById('resumeInput').files[0].size);
    }
    ...
    render() {
        return (
            <form action="/app" method="post">
                ...
                <p>Resume:</p> <input type="text" defaultValue={this.props.appData.resume} name="resume" />
                ...
                <p>Resume:</p> <input type='file' onChange={this.verifyResume.bind(this)} name='resume' id='resumeInput' />
